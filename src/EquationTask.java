...
public class EquationTask implements Callable<Double> {
    ...
    public Double call() throws Exception {
        try {
            ...
            System.err.println("Błąd obliczeń dla równania: " + equation + ": " + e.getMessage());
            return Double.NaN; // Zwróć NaN w przypadku błędu
        }
    }
    ...
    private static double evaluateExpression(String expression) {
        ...
        for (String token : tokens) {
            if (isNumeric(token)) {
                ...
                operators.pop(); // Usuń "(" ze stosu operatorów
